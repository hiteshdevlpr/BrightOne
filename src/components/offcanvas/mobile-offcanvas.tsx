                ...
                <div className="tp-offcanvas-wrapper">
                    ...
                    <div className="tp-offcanvas-main">
                        ...
                        <div className="tp-offcanvas-contact">
                            ...
                            <ul>
                                <li>
                                    <Link href="tel:4164199689">(416) 419-9689</Link>
                                </li>
                                <li>
                                    <Link href="mailto:contact@brightone.ca">contact@brightone.ca</Link>
                                </li>
                                <li>
                                    <Link href="#">Greater Toronto Area, ON</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="tp-offcanvas-social">
                            ...
                            <ul>
                                <li>
                                    <Link href="https://www.facebook.com/BrightOneInc" target="_blank"><i className="fa-brands fa-facebook-f"></i></Link>
                                </li>
                                <li>
                                    <Link href="https://www.instagram.com/brightoneinc" target="_blank"><InstagramTwo /></Link>
                                </li>
                                <li>
                                    <Link href="https://www.linkedin.com/company/brightoneInc/" target="_blank"><i className="fa-brands fa-linkedin-in"></i></Link>
                                </li>
                                <li>
                                    <Link href="https://youtube.com/@brightoneca" target="_blank"><Youtube /></Link>
                                </li>
                            </ul>
                        </div>
                    </div>

...
function fadeAnimation() {
    ...
    if (document.querySelectorAll(".tp_fade_anim").length > 0) {
...
function revelAnimationOne() {
    ...
    if (anim_reveal.length > 0) {
        anim_reveal.forEach((areveal: any) => {
            let duration_value = 1.5 as any;
            let onscroll_value = 1 as any;
            let stagger_value = 0.02 as any;
            let data_delay = 0.05 as any;
...
function revelAnimationTwo() {
    ...
    if (anim_reveal2.length > 0) {
        anim_reveal2.forEach((areveal: any) => {
            let duration_value = 2 as any;
            let onscroll_value = 1 as any;
            let stagger_value = 0.05 as any;
            let data_delay = 0.1 as any;
...
function zoomAnimation() {
    // zoom in
    if (document.querySelectorAll(".anim-zoomin").length > 0) {
        document.querySelectorAll(".anim-zoomin").forEach((el: any) => {
            // Add wrap <div>
            // $(this).wrap('<div class="anim-zoomin-wrap"></div>');
            const wrapper = document.createElement('div');
            wrapper.classList.add('anim-zoomin-wrap');
...
function titleAnimation() {
    if (document.querySelectorAll('.tp_title_anim').length > 0) {

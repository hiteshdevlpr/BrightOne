...
import rePhoto1 from '@/assets/images/hero-slide-1.jpg';
    ...
    <div className="min-h-screen">
      ...
      <section className="py-12 sm:py-16 md:py-24 lg:py-32 bg-gray-200">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 xl:gap-16 w-full">
            {/* Left Side - Hero Image with Overlay */}
            <div className="relative order-1 lg:order-1">
              <Image src={rePhoto1.src} alt="Real Estate Photography" width={800} height={600} className="w-full h-[400px] sm:h-[450px] md:h-[500px] lg:h-[100%] xl:h-[100%] object-cover rounded-lg lg:rounded-none" />
            ...
            <div className="flex flex-col space-y-3 sm:space-y-4 md:space-y-6 lg:space-y-8 order-2 lg:order-2">
              {/* Card 1 - Interior Photography */}
              <div className="bg-gray-800 p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 rounded-lg lg:rounded-none border-b border-gray-700 lg:border-b-0 lg:border-r-0">
                <div className="text-center">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 mb-3 sm:mb-4 md:mb-6 mx-auto">
                  ...
                  <h3 className="text-white text-sm sm:text-lg md:text-xl lg:text-2xl font-bold uppercase mb-2 sm:mb-3 md:mb-4">INTERIOR PHOTOGRAPHY</h3>
              ...
              <div className="bg-gray-800 p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 rounded-lg lg:rounded-none border-b border-gray-700 lg:border-b-0 lg:border-r-0">
                <div className="text-center">
                  ...
                  <h3 className="text-white text-sm sm:text-lg md:text-xl lg:text-2xl font-bold uppercase mb-2 sm:mb-3 md:mb-4">DRONE & EXTERIOR PHOTOGRAPHY</h3>
                  <p className="text-white/80 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed">
              ...
              {/* Card 3 - HDR & Editing */}
              <div className="bg-gray-800 p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 rounded-lg lg:rounded-none">
                <div className="text-center">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 mb-3 sm:mb-4 md:mb-6 mx-auto">
                    <svg className="w-full h-full text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h3 className="text-white text-sm sm:text-lg md:text-xl lg:text-2xl font-bold uppercase mb-2 sm:mb-3 md:mb-4">HDR & PROFESSIONAL EDIT</h3>
                  <p className="text-white/80 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed">
      ...
      <section className="py-12 sm:py-16 md:py-24 lg:py-32 bg-gray-800">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 xl:gap-16 w-full">
            {/* Left Side - Visual */}
            <div className="relative order-1 lg:order-1">
              <div className="bg-gray-900 rounded-lg p-4 sm:p-6 lg:p-8 border border-gray-600">
                <div className="text-center">
                  ...
                  <h3 className="text-lg sm:text-2xl font-bold text-white mb-3 sm:mb-4 font-heading">Custom Listing Website</h3>
                  <p className="text-white/80 font-montserrat mb-4 sm:mb-6 text-xs sm:text-base">
                    Dedicated property websites that showcase your listings with professional design and functionality
                  </p>
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center justify-between bg-gray-700 rounded p-2 sm:p-3">
                      <span className="text-white text-xs sm:text-sm">Photo Gallery</span>
                      <div className="w-2 h-2 sm:w-3 sm:h-3 bg-green-500 rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between bg-gray-700 rounded p-2 sm:p-3">
                      <span className="text-white text-xs sm:text-sm">Virtual Tour</span>
                      <div className="w-2 h-2 sm:w-3 sm:h-3 bg-green-500 rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between bg-gray-700 rounded p-2 sm:p-3">
                      <span className="text-white text-xs sm:text-sm">Floor Plans</span>
                      <div className="w-2 h-2 sm:w-3 sm:h-3 bg-green-500 rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between bg-gray-700 rounded p-2 sm:p-3">
                      <span className="text-white text-xs sm:text-sm">Contact Forms</span>
                      <div className="w-2 h-2 sm:w-3 sm:h-3 bg-green-500 rounded-full"></div>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex flex-col justify-center order-2 lg:order-2">
              <div className="text-center lg:text-left">
                <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 sm:mb-6 leading-tight font-heading">
                  <span className="bright-text-shadow text-black">Listing</span> <span className="bright-text-shadow-dark">Website</span>
                </h2>
                <p className="text-sm sm:text-lg md:text-xl text-white/80 mb-6 sm:mb-8 leading-relaxed font-montserrat">
                ...
                <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-white rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <div className='text-left'>
                      <h4 className="text-sm sm:text-lg font-semibold text-white mb-1 sm:mb-2 font-heading">Custom Design</h4>
                      <p className="text-white/80 font-montserrat text-xs sm:text-base">Tailored website design that matches your brand and property style</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-white rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div className='text-left'>
                      <h4 className="text-sm sm:text-lg font-semibold text-white mb-1 sm:mb-2 font-heading">Mobile Optimized</h4>
                      <p className="text-white/80 font-montserrat text-xs sm:text-base">Responsive design that works perfectly on all devices</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-white rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div className='text-left'>
                      <h4 className="text-sm sm:text-lg font-semibold text-white mb-1 sm:mb-2 font-heading">Lead Generation</h4>
                      <p className="text-white/80 font-montserrat text-xs sm:text-base">Built-in contact forms and lead capture tools</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 xl:gap-16 w-full">
            ...
            <div className="flex flex-col justify-center order-2 lg:order-1">
              <div className="text-center lg:text-left">
                <h2 className="text-2xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight font-heading">
                  Professional <span className="text-gray-600">Floor Plans</span>
                </h2>
                <p className="text-base text-gray-700 mb-8 leading-relaxed font-montserrat">
                ...
                <div className="space-y-6 mb-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className='text-left'>
                      <h4 className="text-base font-semibold text-gray-900 mb-2 text-left font-heading">Accurate Measurements</h4>
                      <p className="text-gray-700 font-montserrat text-sm">Precise room dimensions and square footage calculations</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-gray-900 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div className='text-left'>
                      <h4 className="text-base font-semibold text-gray-900 mb-2 text-left font-heading">Professional Design</h4>
                      <p className="text-gray-700 font-montserrat text-sm">Clean, modern layouts that enhance property presentations</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 bg-gray-900 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div className='text-left'>
                      <h4 className="text-base font-semibold text-gray-900 mb-2 text-left font-heading">Multiple Formats</h4>
                      <p className="text-gray-700 font-montserrat text-sm">Available in PDF, JPG, and interactive digital formats</p>
                    </div>
                  </div>
                </div>

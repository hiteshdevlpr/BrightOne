        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/brightoneinc" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Pinterest */}
              <a href="https://in.pinterest.com/brightOneInc/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/brightoneInc/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href="https://youtube.com/@brightoneca" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">

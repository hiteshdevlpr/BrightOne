      ...
      <div className="bg-gray-900 text-white py-1 px-2 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center text-sm">
          ...
          <div className="flex items-center space-x-3 mt-1 sm:mt-0">
            ...
            {/* Pinterest */}
            <a 
              href="https://in.pinterest.com/brightOneInc/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors"
      ...
      <nav className={`w-full transition-all duration-300 ${
        ...
        <div className={`flex justify-between items-center transition-all duration-300 ${
          ...
          <div className={`hidden md:flex transition-all duration-300 ${
            isScrolled ? 'md:space-x-1.5 lg:space-x-2 xl:space-x-3' : 'md:space-x-2 lg:space-x-3 xl:space-x-4 2xl:space-x-4'
          }`}>
            <Link 
              href="/" 
              className={`text-shadow-lg text-white uppercase transition-all font-montserrat duration-300 rounded-md py-0.5 px-1 border-y-2 border-x-0  hover:border-white ${
                isScrolled ? 'text-xs lg:text-xs xl:text-sm' : 'text-xs lg:text-sm xl:text-base 2xl:text-lg'
              } ${
                isActive('/') 
                  ? 'border-white' 
                  : ' border-transparent'
            ...
            <Link 
              href="/services" 
              className={`uppercase text-white transition-all font-montserrat duration-300 rounded-md py-0.5 px-1 border-y-2 border-x-0  hover:border-white ${
                isScrolled ? 'text-xs lg:text-xs xl:text-sm' : 'text-xs lg:text-sm xl:text-base 2xl:text-lg'
              } ${
                isActive('/services') 
                  ? 'border-white' 
